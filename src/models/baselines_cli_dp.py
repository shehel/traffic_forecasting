...
def run_model(
    ...
    train_loader = DataLoader(model.t_dataset, batch_size=cfg.train.dataloader.batch_size,
    ...
    if cfg.train.dataloader.train_eval and cfg.train.dataloader.train_eval < num_train_items:
        ...
        train_eval_loader = DataLoader(model.t_dataset, batch_size=cfg.train.dataloader.batch_size,
                                                  num_workers=cfg.train.dataloader.num_workers,
    ...
    if cfg.model.valset:
        val_loader = DataLoader(model.v_dataset, batch_size=cfg.train.dataloader.batch_size,
                                           num_workers=cfg.train.dataloader.num_workers, sampler=dev_sampler, collate_fn=train_collate_fn, pin_memory=False)
    else:
        val_loader = DataLoader(model.t_dataset, batch_size=cfg.train.dataloader.batch_size,
                                           num_workers=cfg.train.dataloader.num_workers, sampler=dev_sampler, collate_fn =train_collate_fn, pin_memory=False)
    ...
    train_ignite(device, loss, optimizer, train_loader, train_eval_loader, val_loader, model.network, checkpoints_dir, cfg, t_model=None)
...
def train_ignite(device, loss, optimizer, train_loader, train_eval_loader, val_loader,
                 train_model, checkpoints_dir, cfg, t_model=None):
    # Validator
