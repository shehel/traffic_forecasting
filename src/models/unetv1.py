...
class UNet(nn.Module):
    def __init__(self, in_channels, kernel_size, padding, num_groups, out_channels, hidden_channels=[128,256]) :
        ...
        for i in reversed(range(len(hidden_channels) - 1)):
            self.up_path.append(
                UNetUpBlock(
                    in_channels=hidden_channels[i + 1],
                    out_channels=hidden_channels[i],
        ...
        self.out = nn.Conv2d(hidden_channels[0], out_channels, kernel_size=(1, 1))
